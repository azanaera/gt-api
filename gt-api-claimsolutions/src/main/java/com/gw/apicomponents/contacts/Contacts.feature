Feature: Contacts
  ...
  Scenario: create a new contact
    ...
    * def createNewContactTemplate = 'classpath:com/gw/apicomponents/contacts/createNewContact.json'
  ...
  Scenario: Update  contact's last name
    ...
    * def updateContactTemplate = 'classpath:com/gw/apicomponents/contacts/updateContact.json'
