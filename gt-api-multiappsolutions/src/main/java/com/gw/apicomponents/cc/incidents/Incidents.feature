Feature: Incidents
  ...
  Scenario: create an incident
    ...
    * def createAnIncidentTemplate = 'classpath:com/gw/apicomponents/cc/incidents/createVehicleIncident.json'
  ...
  Scenario: create a fixed property incident
    * def requiredArguments = ['claimId']
    * def createFixedPropertyIncidentTemplate = 'classpath:com/gw/apicomponents/cc/incidents/createFixedPropertyVehicleIncident.json'
  ...
  Scenario: create a dwelling incident
    ...
    * def createDwellingIncidentTemplate = 'classpath:com/gw/apicomponents/cc/incidents/createDwellingIncident.json'
  ...
  Scenario: create a bodily injury incident
    ...
    * def createInjuryIncidentTemplate = 'classpath:com/gw/apicomponents/cc/incidents/createInjuryIncident.json'
