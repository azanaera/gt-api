Feature: Exposures
  ...
  Scenario: Create an exposure with Vehicle Incident
    ...
    * def createExposureTemplate = 'classpath:com/gw/apicomponents/exposures/createExposureWithVehicleIncident.json'
  ...
  Scenario: close the exposure
    ...
    * def closeExposureTemplate = 'classpath:com/gw/apicomponents/exposures/closeExposure.json'
  ...
  Scenario: update the jurisdiction code in exposure
    * def requiredArguments = ['claimId','exposureId']
    * def updateExposureTemplate = 'classpath:com/gw/apicomponents/exposures/updateExposure.json'
  ...
  Scenario: Create a BuildingCoverage exposure
    * def requiredArguments = ['claimId']
    * def createCPExposureTemplate = 'classpath:com/gw/apicomponents/exposures/createExposureWithBuildingCoverage.json'
    * def createExposureUrl = claimsUrl + "/" + __arg.scenarioArgs.claimId + '/exposures'
    Given url createExposureUrl
 ...
 # close all exposures - some got created by a business rule
  ...
  Scenario: Create an exposure with Dwelling incident
    ...
    * def createExposureWithDwellingIncidentTemplate = 'classpath:com/gw/apicomponents/exposures/createExposureWithDwellingIncident.json'
  ...
  Scenario: Create an exposure with Living Expenses incident
    ...
    * def createExposureWithLivingExpensesIncidentTemplate = 'classpath:com/gw/apicomponents/exposures/createExposureWithLivingExpensesIncident.json'
  ...
  Scenario: Update claimant on Exposure to the new contact
    ...
    * def updateExposureWithClaimantTemplate = 'classpath:com/gw/apicomponents/exposures/updateClaimantOnExposure.json'
  ...
  Scenario: Create an exposure with bodily injury incident
    * def requiredArguments = ['claimId']
    * def createExposureTemplate = 'classpath:com/gw/apicomponents/exposures/createExposureWithBodilyInjuryIncident.json'
    * def createExposureUrl = claimsUrl + "/" + __arg.scenarioArgs.claimId + '/exposures'
    Given url createExposureUrl
    And request readWithArgs(createExposureTemplate, __arg.templateArgs)
    When method POST
