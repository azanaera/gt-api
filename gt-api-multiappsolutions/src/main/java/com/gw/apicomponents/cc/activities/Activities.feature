Feature: Activities
  ...
  Scenario: Create an activity
    ...
    * def createActivityTemplate = 'classpath:com/gw/apicomponents/cc/activities/createActivity.json'
  ...
  Scenario: close given activity
    * def requiredArguments = ['activityId']
    * def closeActivityTemplate = 'classpath:com/gw/apicomponents/cc/activities/closeActivity.json'
  ...
  Scenario: Edit Activity description
    * def requiredArguments = ['activityId']
    * def editActivityTemplate = 'classpath:com/gw/apicomponents/cc/activities/editActivity.json'
  ...
  Scenario: Reassign Activity to another Adjuster
    ...
    * def reassignActivityTemplate = 'classpath:com/gw/apicomponents/cc/activities/reassignActivity.json'
    Given url activityUrl
