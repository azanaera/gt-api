package com.gw.cucumber;

import com.gw.execution.*;
import com.gw.util.LogFilters;
...
public class CucumberStep {
    ...
    public void beforeScenario(Scenario scenario) {
        ...
        if (isGtApiScenario) {
            ...
            KarateExecutionHelper.isCucumberExecution = !isGtApiScenario;
    ...
    public void anyStepWithoutDataTable() {
        if(isGtApiScenario){
            ...
            Map<String, Object> result = new GtApiStep(stepGtApiScenario, stepTextParametersMap).execute();
            CucumberDataCache.putAll((Map<String, Object>) result.get("stepVariables"));
            this.currentScenario.write(LogFilters.getCucumberStepLog());
        }
    }
